...
const gaitParamSettings = {
    ...
    tt: {
        ...
        trotVelocity: { default: 0.00, max: 1.50, min: -1.50, clear: 0.00, delta: 0.3, prefix: "trot_vel", type: "f"},
        sideVelocity: { default: 0.00, max: 1.50, min: -1.50, clear: 0.00, delta: 0.3, prefix: "side_vel", type: "f"},
...
const gaitParamModifyRule = {
    ...
    tt: {
        ...
        axisMap: {
            "RH": { action: "setAxis", param: "trotVelocity", valueMap: (x) => (2.0 * x) },
            "RV": { action: "setAxis", param: "sideVelocity", valueMap: (x) => (2.0 * x) },
        }
    },
};
